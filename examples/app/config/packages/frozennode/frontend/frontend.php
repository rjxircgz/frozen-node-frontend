...
return array(
	 ...
	 * @type string
	 */
	'model_config_path' => app('path') . '/config/frontend',
	 ...
	 * @type string
	 */
	'settings_config_path' => app('path') . '/config/frontend/settings',
	 ...
	 * is allowed to view the frontend section. Any "falsey" response will send the user back to the 'login_path' defined below.
	 *
	 * @type closure
	 */
	'permission'=> function()
	{
		return true;
		//return Auth::user()->hasRole('frontend');
	},
	...
	/**
	 * The menu item that should be used as the default landing page of the frontend section
	 *
	 * @type string
	 */
	...
	/**
	 * This is the path where Frontend will send the user if they are not logged in (!Auth::check())
	 *
	 * @type string
	 */
	...
	/**
	 * The logout path is the path where Frontend will send the user when they click the logout link
	 *
	 * @type string
	 */
	...
	/**
	 * An array of available locale strings. This determines which locales are available in the languages menu at the top right of the Frontend
	 * interface.
	 *
	 * @type array
	 */
