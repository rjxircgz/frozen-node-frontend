...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->validator = m::mock('Frozennode\Frontend\Validator')->makePartial();
	}
	...
	{
		$this->assertTrue($this->validator->validateEloquent(null, 'Frozennode\Frontend\Tests\EloquentStub', null));
	}
