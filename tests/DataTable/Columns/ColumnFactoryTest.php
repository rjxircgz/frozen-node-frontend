<?php
namespace Frozennode\Frontend\Tests\DataTable\Columns;
...
class ColumnFactoryTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @var string
	 */
	protected $namespace = 'Frozennode\\Frontend\\DataTable\\Columns\\';
	...
	public function setUp()
	{
		...
		$this->config = m::mock('Frozennode\Frontend\Config\Model\Config');
		$this->db = m::mock('Illuminate\Database\DatabaseManager');
		$this->factory = m::mock('Frozennode\Frontend\DataTable\Columns\Factory', array($this->validator, $this->config, $this->db))->makePartial();
	}
	...
	{
		$stub = new ColumnStub;
		$this->factory->shouldReceive('getColumnClassName')->once()->andReturn('Frozennode\Frontend\Tests\DataTable\Columns\ColumnStub');
	...
	public function testGetIncludedColumnsReturnsColumns()
	{
		...
		$columnRelated = m::mock('Frozennode\Frontend\DataTable\Columns\Column');
		...
		$columnNormal = m::mock('Frozennode\Frontend\DataTable\Columns\Column');
		$columnNormal->shouldReceive('getOption')->times(4)->andReturn(false, false, 'normal', 'normal');
		$columnComputed = m::mock('Frozennode\Frontend\DataTable\Columns\Column');
	...
	public function testGetIncludedColumnsAddsBelongsToField()
	{
		...
		$field = m::mock('Frozennode\\Frontend\\Fields\\Relationships\\BelongsTo');
