...
class DataTableTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->columnFactory = m::mock('Frozennode\Frontend\DataTable\Columns\Factory');
		$this->fieldFactory = m::mock('Frozennode\Frontend\Fields\Factory');
		$this->dataTable = m::mock('Frozennode\Frontend\DataTable\DataTable', array($this->config, $this->columnFactory, $this->fieldFactory))
								->makePartial();
	}
	...
	{
		$column = m::mock('Frozennode\Frontend\DataTable\Columns\Column');
	...
	{
		$column1 = m::mock('Frozennode\Frontend\DataTable\Columns\Column');
		$column1->shouldReceive('renderOutput')->once()->andReturn('rendered');
		$column2 = m::mock('Frozennode\Frontend\DataTable\Columns\Column');
