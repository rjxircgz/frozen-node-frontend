<?php
namespace Frozennode\Frontend\Tests\Config\Settings;
...
class SettingsConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->config = m::mock('Frozennode\Frontend\Config\Settings\Config', array($this->validator, $this->validator, array()))->makePartial();
	}
