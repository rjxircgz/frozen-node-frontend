<?php
namespace Frozennode\Frontend\Tests\Config\Model;
...
class ModelConfigTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->config = m::mock('Frozennode\Frontend\Config\Model\Config', array($this->validator, $this->validator, array()))->makePartial();
	}
	...
	{
		$stubClass = 'Frozennode\Frontend\Tests\Config\Model\EloquentStub';
	...
	public function testGetModel()
	{
		...
		$field = m::mock('Frozennode\Frontend\Fields\Field');
	...
	public function testUpdateModelWithLink()
	{
		...
		$fieldFactory = m::mock('Frozennode\Frontend\Fields\Factory');
		$fieldFactory->shouldReceive('getEditFieldsArrays')->once();
		$actionFactory = m::mock('Frozennode\Frontend\Actions\Factory');
