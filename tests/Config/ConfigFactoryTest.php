...
use Mockery as m;
use Frozennode\Frontend\Config\Factory;
...
class ConfigFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	{
		$configMock = m::mock('Frozennode\Frontend\Config\Model\Config');
		$factory = m::mock('Frozennode\Frontend\Config\Factory[parseType,searchMenu,getItemConfigObject]', array($this->validator, $this->validator, array()));
	...
	{
		$configMock = m::mock('Frozennode\Frontend\Config\Model\Config');
		$factory = m::mock('Frozennode\Frontend\Config\Factory[parseType,searchMenu]', array($this->validator, $this->validator, array()));
	...
	{
		$config = m::mock('Frozennode\Frontend\Config\Config');
		$config->shouldReceive('setOptions')->once();
		$factory = m::mock('Frozennode\Frontend\Config\Factory[searchMenu,getConfig]', array($this->validator, $this->validator, array()));
	...
	public function testModelInMenu()
	{
		...
		$factory = m::mock('Frozennode\Frontend\Config\Factory[fetchConfigFile]', array($this->validator, $this->validator, $config));
	...
	public function testFetchConfigWorks()
	{
		...
		$factory = m::mock('Frozennode\Frontend\Config\Factory[getPath,getPrefix]', array($this->validator, $this->validator, array()));
