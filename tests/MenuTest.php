<?php
namespace Frozennode\Frontend\Tests;
...
class MenuTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->configFactory = m::mock('Frozennode\Frontend\Config\Factory');
		$this->menu = m::mock('Frozennode\Frontend\Menu', array($this->config, $this->configFactory))->makePartial();
	}
	...
	public function testGetMenuSimpleReturnWithPermission()
	{
		...
		$itemconfig = m::mock('Frozennode\Frontend\Config\Config');
