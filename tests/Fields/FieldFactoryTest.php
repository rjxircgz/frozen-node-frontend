<?php
namespace Frozennode\Frontend\Tests\Fields;
...
class FieldFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->factory = m::mock('Frozennode\Frontend\Fields\Factory', array($this->validator, $this->config, $this->db))->makePartial();
	}
	...
	{
		$this->factory->shouldReceive('getFieldTypeClass')->once()->andReturn('Frozennode\Frontend\Tests\Fields\FieldStub');
	...
	public function testApplyConstraints()
	{
		...
		$otherField = m::mock('Frozennode\Frontend\Fields\Field');
