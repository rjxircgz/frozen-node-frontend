...
return array(
	 ...
	 * @type string
	 */
	'model_config_path' => config_path('frontend'),
	 ...
	 * @type string
	 */
	'settings_config_path' => config_path('frontend/settings'),
	...
	/**
	 * The login path is the path where Frontend will send the user if they fail a permission check
	 *
	 * @type string
	 */
