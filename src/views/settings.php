...
<script type="text/javascript">
	var site_url = "<?php echo url() ?>",
		...
		save_url = "<?php echo route('frontend_settings_save', array($config->getOption('name'))) ?>",
		custom_action_url = "<?php echo route('frontend_settings_custom_action', array($config->getOption('name'))) ?>",
		file_url = "<?php echo route('frontend_settings_display_file', array($config->getOption('name'))) ?>",
...
<script id="settingsTemplate" type="text/html">
	<?php echo view("frontend::templates.settings")?>
</script>