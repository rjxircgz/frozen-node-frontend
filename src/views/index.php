...
<script type="text/javascript">
	var site_url = "<?php echo url() ?>",
		...
		file_url = "<?php echo route('frontend_display_file', array($config->getOption('name'))) ?>",
		rows_per_page_url = "<?php echo route('frontend_rows_per_page', array($config->getOption('name'))) ?>",
		...
		frontendData = {
			...
			languages: <?php echo json_encode(trans('frontend::knockout')) ?>
		};
</script>
...
<script id="frontendTemplate" type="text/html">
	<?php echo view("frontend::templates.frontend")?>
</script>

<script id="itemFormTemplate" type="text/html">
	<?php echo view("frontend::templates.edit", array('config' => $config))?>
</script>

<script id="filtersTemplate" type="text/html">
	<?php echo view("frontend::templates.filters")?>
</script>