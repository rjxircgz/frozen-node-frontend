<?php
namespace Frozennode\Frontend\Config\Model;

use Frozennode\Frontend\Config\Config as ConfigBase;
use Frozennode\Frontend\Config\ConfigInterface;
use Frozennode\Frontend\Fields\Factory as FieldFactory;
use Frozennode\Frontend\Fields\Field as Field;
...
class Config extends ConfigBase implements ConfigInterface {
	 ...
	 *
	 * @param \Illuminate\Database\Eloquent\Model		$model
	 * @param \Frozennode\Frontend\Fields\Factory	$fieldFactory
	 * @param \Frozennode\Frontend\Actions\Factory	$actionFactory
	 *
	 * @return \Illuminate\Database\Eloquent\Model
	 */
	public function updateModel($model, FieldFactory $fieldFactory, ActionFactory $actionFactory)
	{
		...
		{
			$model->setAttribute('frontend_item_link', $link);
		}

		//set up the model with the edit fields new data
		$model->setAttribute('frontend_edit_fields', $fieldFactory->getEditFieldsArrays(true));

		//set up the new actions data
		$model->setAttribute('frontend_actions', $actionFactory->getActionsOptions(true));
		$model->setAttribute('frontend_action_permissions', $actionFactory->getActionPermissions(true));
