<?php
namespace Frozennode\Frontend\DataTable\Columns;

use Frozennode\Frontend\Validator;
use Frozennode\Frontend\Config\ConfigInterface;
use Illuminate\Database\DatabaseManager as DB;

use Frozennode\Frontend\DataTable\Columns\Relationships\BelongsTo;
use Frozennode\Frontend\DataTable\Columns\Relationships\BelongsToMany;
use Frozennode\Frontend\DataTable\Columns\Relationships\HasOneOrMany;
...
class Factory {
	 ...
	 * @param array		$options
	 *
	 * @return \Frozennode\Frontend\DataTable\Columns\Column
	 */
	...
	public function getIncludedColumns(array $fields)
	{
		...
		if (!sizeof($this->includedColumns))
		{
			...
			{
				if (is_a($field, 'Frozennode\\Frontend\\Fields\\Relationships\\BelongsTo'))
				{
