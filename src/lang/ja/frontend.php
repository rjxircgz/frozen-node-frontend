...
return array(
	...
	*/
	...
	'valid_menu' => "有効な 'menu' オプションを frontend.php の設定で指定してください",
	'valid_config_path' => "有効な 'model_config_path' オプションを frontend.php の設定で指定してください。このディレクトリは存在していてかつ読取可能にしてください。",
