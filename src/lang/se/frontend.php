...
return array(
	...
	*/
	...
	'valid_menu' => "Du måste ange en giltig 'menu'-option i frontend.php:s konfiguration",
	'valid_config_path' => "Du måste ange en giltig 'model_config_path' i frontend.php:s konfiguration. Katalogen måste även existera samt vara skrivbar.",
